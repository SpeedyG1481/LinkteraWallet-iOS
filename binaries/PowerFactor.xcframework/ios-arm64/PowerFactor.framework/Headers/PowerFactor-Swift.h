...
#ifndef POWERFACTOR_SWIFT_H
#define POWERFACTOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PowerFactor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC11PowerFactor28ApproveQRTransactionResponse")
@interface ApproveQRTransactionResponse : NSObject
...
SWIFT_CLASS_NAMED("ClientLog")
@interface ClientLog : NSManagedObject
...
@interface ClientLog (SWIFT_EXTENSION(PowerFactor))
@property (nonatomic, copy) NSString * _Nullable customerid;
@property (nonatomic, copy) NSString * _Nullable message;
@property (nonatomic, copy) NSString * _Nullable messagedate;
@property (nonatomic) int16_t messagetype;
@property (nonatomic, copy) NSString * _Nullable methodname;
...
SWIFT_CLASS("_TtC11PowerFactor3OTP")
...
SWIFT_CLASS("_TtC11PowerFactor21PWFActivationResponse")
@interface PWFActivationResponse : NSObject
@property (nonatomic, copy) NSString * _Nullable ActivationToken;
@property (nonatomic, copy) NSString * _Nullable MaskedIdentifier;
@property (nonatomic, copy) NSString * _Nullable CustomerId;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11PowerFactor13PWFBaseObject")
@interface PWFBaseObject : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


@interface PWFBaseObject (SWIFT_EXTENSION(PowerFactor))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC11PowerFactor15PWFClientResult")
@interface PWFClientResult : PWFBaseObject
...
- (nonnull instancetype)initWithErrorCode:(NSString * _Nullable)errorCode errorMessage:(NSString * _Nullable)errorMessage OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC11PowerFactor16PWFLoginResponse")
@interface PWFLoginResponse : NSObject
@property (nonatomic, copy) NSString * _Nullable LoginOtp;
@property (nonatomic, copy) NSString * _Nullable ActivationToken;
- (nonnull instancetype)initWithLoginOtp:(NSString * _Nullable)loginOtp activationToken:(NSString * _Nullable)activationToken OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11PowerFactor22PWFTransactionContract")
@interface PWFTransactionContract : NSObject
@property (nonatomic, copy) NSString * _Nullable TransactionContent;
@property (nonatomic, copy) NSString * _Nullable TransactionToken;
@property (nonatomic, copy) NSString * _Nullable TransactionName;
@property (nonatomic, copy) NSString * _Nullable TransactionBeginDate;
@property (nonatomic, copy) NSString * _Nullable TransactionType;
@property (nonatomic, copy) NSArray<NSNumber *> * _Nullable TransactionApprovementTypeList;
@property (nonatomic) NSInteger TransactionRemainingTime;
@property (nonatomic) BOOL CancelOnBackPress;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11PowerFactor15PWFUserContract")
@interface PWFUserContract : PWFBaseObject
@property (nonatomic) int64_t CustomerId;
@property (nonatomic) BOOL IsBiometricEnable;
@property (nonatomic) BOOL IsSE;
- (nonnull instancetype)initWithCustomerId:(int64_t)customerId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCustomerId:(int64_t)customerId isBiometricEnable:(BOOL)isBiometricEnable OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCustomerId:(int64_t)customerId isBiometricEnable:(BOOL)isBiometricEnable isSE:(BOOL)isSE activationRef:(NSString * _Nullable)activationRef OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC11PowerFactor18PowerFactorMethods")
@interface PowerFactorMethods : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, QRTransactionStatus, open) {
  QRTransactionStatusApproved = 1,
  QRTransactionStatusWaitingApproval = 2,
  QRTransactionStatusWaitingSecondVerification = 3,
  QRTransactionStatusErrorOccured = 4,
  QRTransactionStatusExpired = 5,
  QRTransactionStatusSecondaryVerificationExpired = 6,
  QRTransactionStatusSecondaryVerificationRejected = 7,
  QRTransactionStatusFraud = 8,
  QRTransactionStatusUsed = 9,
};
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC11PowerFactor16ReadMoreTextView")
...
SWIFT_CLASS("_TtC11PowerFactor5Token")
...
SWIFT_CLASS("_TtC11PowerFactor24TransactionOwnerContract")
@interface TransactionOwnerContract : PWFBaseObject
@property (nonatomic, copy) NSString * _Nullable OwnerKey;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


typedef SWIFT_ENUM(NSInteger, TransactionStatusNames, open) {
  TransactionStatusNamesRejected = 0,
  TransactionStatusNamesApproved = 1,
  TransactionStatusNamesWaitingApproval = 2,
  TransactionStatusNamesErrorOccured = 3,
  TransactionStatusNamesExpired = 4,
  TransactionStatusNamesFraud = 5,
  TransactionStatusNamesCanceled = 6,
};

typedef SWIFT_ENUM(NSInteger, TransactionTypes, open) {
  TransactionTypesClientTransaction = 1,
  TransactionTypesMobileApproval = 2,
  TransactionTypesOneTouchTransaction = 3,
  TransactionTypesQRTransaction = 4,
  TransactionTypesSoft_otp = 5,
  TransactionTypesVpn_transaction = 6,
};
